...
st.set_page_config(
    page_title="RevScrap by OJO",
    page_icon="⭐",
    menu_items={
        'About': "### Website that scrapes Google for reviews of an item (product, movie, etc.) and runs sentiment analysis on the results !"
    }
)
...
item = form.text_input('Enter name of product, movie, song, etc. to perform search for reviews: ', value='Oppenheimer')
...
st.text('Project by Omkar Ovhal')    
st.caption('Connect with me [Gmail](mailto:omovhal@gmail.com) [LinkedIn](https://www.linkedin.com/in/omkar-ovhal/)')
